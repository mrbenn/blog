...
# Make cucs atomic for running - sort out the ordering (this will mean creating page objects or modules using site prism)
# build stubbs
# fix and add Factoy Girl data (stubbs)
# Puppetise the solution
# Fix the alert popup on the delete comments page
